...
export function SubpanelCloseBar({
  ...
  return (
    <button
      type="button"
      onClick={onClose}
      className={`flex h-filter-close-bar w-full shrink-0 items-center border-b-hairline border-solid border-border ${showTopBorder ? "border-t-hairline" : "border-t-0"} px-3 text-ink-primary ${interactiveChromeMatClass} ${interactiveChromeHoverClass} focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-ink-primary`}
