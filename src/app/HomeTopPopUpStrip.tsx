...
export function HomeTopPopUpStrip() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-30 hidden h-[calc(var(--inset-margin-guide)+1px)] border-b-hairline border-solid border-border bg-[#E9E9E9] lg:block">
